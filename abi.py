    ...
    try:
      ...
      while icapa:
        ...
        if str(rei[0]) = str(self.name):
          self.driver.find_element(By.XPATH,'//*[@id="login-form"]/table/tbody/tr[3]/td/div/label['+rei[1]+']').click()
          time.sleep(2) 
